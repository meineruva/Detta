...
exports.analyzeCheckIn = void 0;
const functions = require("firebase-functions");
const admin = require("firebase-admin");
const db = admin.firestore();
exports.analyzeCheckIn = functions.firestore
    ...
    if (userData === null || userData === void 0 ? void 0 : userData.boundDevice) {
    ...
    if (flags.length > 0) {
        const flagDoc = {
            userId,
            classId: (userData === null || userData === void 0 ? void 0 : userData.classId) || "unknown",
...
//# sourceMappingURL=analyzeCheckIn.js.map